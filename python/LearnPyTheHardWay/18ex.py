...
# ok, that's *args is pointless, we can just do this
...
# 4. Did you put arguments after the parenthesis `(` separated by commas?
# 5. Did you make each argument unique (meaning no duplicated names)?
# 6. Did you put a parenthesis and a colon `):` after the arguments?
